          ...
          <div className="bg-kivaro-surface rounded-xl border border-kivaro-border">
            <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
              <div className="p-4 rounded-full bg-kivaro-primary-50 mb-4">
                <Zap className="h-8 w-8 text-kivaro-primary" />
              </div>
            ...
            {filteredResponses.map((response) => (
              ...
              >
                <div className="flex items-start justify-between mb-2">
                  <h3 className="text-sm font-semibold text-kivaro-text truncate flex-1 mr-2">
                    {response.title}
                  </h3>
                ...
                <p className="text-sm text-kivaro-text-light line-clamp-3 mb-4 min-h-[3.75rem]">
                  {response.content}
                </p>

                <div className="flex items-center justify-between pt-3 border-t border-kivaro-border">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-1 text-xs text-kivaro-text-light">
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      response.isActive ? "bg-kivaro-success" : "bg-gray-300"
                    )}
                  >
                    <span
                      className={cn(
